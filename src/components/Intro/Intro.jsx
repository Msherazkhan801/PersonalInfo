  ...
  return (
    <div className="Intro" id="Intro">
      ...
      <div className="i-left">
        ...
        <a href="https://github.com/Msherazkhan801" target="_blank" rel="noreferrer" ><img src={Github} alt="" /></a>
        <a href="https://www.linkedin.com/in/sheraz-khan-343339160/" target="_blank" rel="noreferrer" > <img src={LinkedIn} alt="" /></a>
        <a href="https://instagram.com/sherazkhan801/" target="_blank" rel="noreferrer" ><img src={Instagram} alt="" /></a>
        </div>
      </div>
      {/* right image side */}
